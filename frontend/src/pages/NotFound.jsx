...
export default function NotFound() {
  return (
    <>
      {/* SEO: PENTRU PAGINA 404 */}
      <SEO 
        title="Piesă Lipsă - Eroare 404" 
        description="Ne pare rău, dar pagina căutată nu a fost găsită în build-ul nostru. Revino la shop-ul Karix Computers pentru cele mai bune oferte la sisteme PC și service."
      />
