    ...
    <div className="min-h-screen pt-32 pb-24 px-4 relative overflow-hidden bg-transparent">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
            ...
            <p className="text-gray-400 text-lg mb-10 font-medium italic">Expertiză tehnică și suport dedicat pentru setup-ul tău.</p>
        ...
        {/* SECȚIUNE NOUĂ: QUICK TIPS & MAINTENANCE */}
        <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="p-6 rounded-[28px] bg-emerald-500/5 border border-emerald-500/10 backdrop-blur-md hover:bg-emerald-500/10 transition-all">
                    <p className="text-emerald-400 font-black text-[9px] uppercase tracking-widest mb-2 italic">Packaging</p>
                    <p className="text-gray-300 text-xs leading-relaxed">
                        Păstrează cutiile originale! Sunt cea mai bună variantă pentru transport în siguranță dacă trimiți PC-ul pentru mentenanță sau garanție.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-20">
            <div className="p-10 rounded-[40px] bg-white/[0.02] border border-white/5 text-left group hover:border-indigo-500/20 transition-all">
            ...
            <div className="p-10 rounded-[40px] bg-gradient-to-br from-indigo-500 to-pink-500 text-left relative overflow-hidden group shadow-2xl hover:scale-[1.01] transition-all">
