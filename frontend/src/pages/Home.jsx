...
export default function Home() {
  ...
  return (
    <>
      {/* SEO: CONFIGURARE PENTRU PAGINA PRINCIPALĂ */}
      <SEO 
        title="Gaming PCs & Service Calculatoare Oradea" 
        description="Karix Computers - Sisteme PC de gaming de înaltă performanță, service profesional cu ridicare gratuită în Oradea și soluții IT de elită. Build-ul tău, misiunea noastră."
      />
      ...
      <div className="min-h-screen text-gray-200 relative overflow-x-hidden">
        ...
        >
          ...
          <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto mb-10 font-medium leading-relaxed drop-shadow-md text-center">
        ...
        {/* --- SECTION 1: LOGISTICA SERVICE ORADEA --- */}
        <motion.section 
          initial="hidden"
          whileInView="visible"
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
            {[
              ...
              <motion.div 
                ...
                className="p-8 rounded-3xl bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] hover:border-white/10 transition-all duration-300 group backdrop-blur-sm text-left"
              >
