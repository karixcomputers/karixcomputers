...
export default function ServiceRequest() {
  ...
  const [isSubmitted, setIsSubmitted] = useState(false); // State pentru succes
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      setIsSubmitted(true); // Înlocuim alert-ul cu starea de succes
  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-4 flex justify-center bg-transparent">
      <div className="max-w-2xl w-full relative z-10">
        <h1 className="text-4xl font-black text-white italic uppercase tracking-tighter mb-2 text-left drop-shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 bg-[#0b1020]/80 p-8 md:p-12 rounded-[40px] border border-white/10 backdrop-blur-3xl shadow-2xl">
          
          {/* MESAJ DE EROARE INTEGRAT (În loc de alert) */}
          {mutation.isError && (
            <div className="p-4 bg-rose-500/10 border border-rose-500/20 rounded-2xl text-rose-500 text-xs font-bold italic animate-in slide-in-from-top-2">
          ...
          <div>
            ...
            <textarea 
              ...
              className="w-full bg-white/5 border border-white/10 rounded-3xl px-6 py-5 text-white outline-none focus:border-indigo-500 transition-all min-h-[120px] resize-none shadow-inner"
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input 
                type="date" required
                className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white outline-none focus:border-indigo-500 transition-all [color-scheme:dark]"
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-top-4 duration-300">
              <div className="grid grid-cols-2 gap-6">
                <div>
                  ...
                  <select 
                    required
                    className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white outline-none focus:border-indigo-500 transition-all appearance-none cursor-pointer shadow-inner"
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white outline-none focus:border-indigo-500 transition-all shadow-inner"
