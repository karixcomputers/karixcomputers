...
export default function ReturnRequest() {
  ...
  if (isSubmitted) {
    return (
      <>
        <SEO title="Cerere Retur Trimisă" description="Solicitarea ta de retur a fost înregistrată cu succes în sistemul Karix Computers." />
        <div className="min-h-screen pt-40 pb-20 px-4 flex items-start justify-center animate-in fade-in zoom-in duration-500 text-center">
          <div className="max-w-md w-full bg-[#0b1020]/90 border border-rose-500/30 p-10 rounded-[40px] backdrop-blur-3xl shadow-2xl">
  ...
  return (
    <>
      <SEO 
        title={`Cerere Retur #${orderRef}`} 
        description="Configurează detaliile pentru returul produselor tale Karix Computers. Alege produsele, metoda de ridicare și datele pentru rambursare." 
      />
      ...
      <div className="min-h-screen pt-32 pb-20 px-4 flex justify-center bg-transparent">
        <div className="max-w-3xl w-full relative z-10">
          ...
          <header className="mb-10 text-left">
            <h1 className="text-5xl font-black text-white italic uppercase tracking-tighter mb-2 drop-shadow-2xl text-left">
              Configurare <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-rose-600">Retur</span>
            </h1>
            <p className="text-gray-400 text-sm italic border-l-2 border-rose-500 pl-4 text-left">
          ...
          <form onSubmit={handleSubmit} className="space-y-8 bg-[#0b1020]/80 p-8 md:p-14 rounded-[50px] border border-white/10 backdrop-blur-3xl shadow-2xl text-left">
            ...
            {mutation.isError && (
              <div className="p-4 bg-rose-500/10 border border-rose-500/20 rounded-2xl text-rose-500 text-xs font-bold italic text-center">
            ...
            <section className={`space-y-6 transition-all duration-500 ${selectedItems.length === 0 ? "opacity-20 pointer-events-none blur-[2px]" : "opacity-100"}`}>
              <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
                 <div className="flex items-center gap-4">
                    ...
                    <label className="text-[10px] font-black text-white uppercase tracking-[0.3em] italic text-left">Locație ridicare colet</label>
                 </div>
            ...
            <section className={`space-y-8 transition-all duration-700 ${selectedItems.length === 0 ? "opacity-20 pointer-events-none blur-[2px]" : "opacity-100"}`}>
              <header className="flex items-center gap-4 mb-6">
                 ...
                 <label className="text-[10px] font-black text-white uppercase tracking-[0.3em] italic text-left">Informații rambursare</label>
              </header>
            ...
            {/* FOOTER ACȚIUNE */}
            <div className="pt-10 flex flex-col gap-6 text-center">
              <div className="p-6 rounded-[30px] bg-rose-500/5 border border-rose-500/10 text-rose-300 text-[10px] italic leading-relaxed font-medium">
