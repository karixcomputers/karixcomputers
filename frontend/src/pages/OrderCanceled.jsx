...
export default function OrderCanceled() {
  ...
  return (
    <>
      {/* SEO: PENTRU PAGINA DE COMANDĂ ANULATĂ */}
      <SEO 
        title="Comandă Anulată" 
        description="Procesul de plată a fost întrerupt sau anulat. Produsele rămân în coșul tău dacă dorești să reiei comanda."
      />
