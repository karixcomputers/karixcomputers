...
export default function Login() {
  ...
  // --- 3. REDIRECT MANUAL ABSOLUT (ZERO POPUP) ---
    ...
    <div className="min-h-screen pt-32 pb-24 px-4 relative flex justify-center bg-transparent">
      <div className="max-w-md w-full relative z-10">
        <div className="rounded-[40px] border border-white/10 bg-white/5 backdrop-blur-md p-8 sm:p-10 shadow-2xl transition-all duration-500">
          ...
          {/* ========================================= */}
          {/* INTERFAȚA 1: FINALIZARE PROFIL (CLIENT NOU) */}
          {/* ========================================= */}
          {isCompletingProfile ? (
              ...
              <form onSubmit={handleCompleteProfile} className="space-y-6">
                <div className="space-y-4">
                  <div className="space-y-1">
                    <label className="text-[10px] uppercase tracking-widest font-bold text-gray-400 ml-2">Nume Complet</label>
                    <input
                      required
                      type="text"
                  ...
                  <div className="space-y-1">
                    <label className="text-[10px] uppercase tracking-widest font-bold text-gray-400 ml-2">Telefon</label>
                    <input
                      required
                      type="tel"
          ...
          /* ========================================= */
          /* INTERFAȚA 2: LOGARE CLASICĂ (DEFAULT)     */
          /* ========================================= */
