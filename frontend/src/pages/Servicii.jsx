...
export default function Login() {
  ...
  return (
    /* Modificat: bg-transparent pentru a vedea animația globală a site-ului */
    <div className="min-h-screen pt-32 pb-24 px-4 relative overflow-hidden flex justify-center bg-transparent">
      
      {/* --- GLOW-URI DE FUNDAL (Stil Servicii) --- */}
      <div className="absolute top-20 left-10 w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-indigo-500/10 blur-[120px] rounded-full pointer-events-none animate-pulse" />
      <div className="absolute bottom-10 right-10 w-[300px] md:w-[400px] h-[300px] md:h-[400px] bg-pink-500/10 blur-[120px] rounded-full pointer-events-none animate-bounce duration-[10s]" />
