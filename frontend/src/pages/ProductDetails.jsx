  ...
  return (
    <>
      ...
      <SEO 
        ...
        url={`https://karixcomputers.ro/product/${id}`}
      />
                      ...
                      <div className="space-y-6 max-h-[600px] overflow-y-auto pr-4 scrollbar-hide">
                          {product.reviews?.filter(r => !r.isDeleted).length > 0 ? (
                            product.reviews.filter(r => !r.isDeleted).map((r, i) => (
                              <div key={i} className="p-8 rounded-[40px] bg-white/5 border border-white/10 backdrop-blur-md space-y-4 shadow-lg text-left">
                          ...
                          {user ? (
                              <form onSubmit={handleReviewSubmit} className="space-y-6">
                                  ...
                                  <textarea 
                                    ...
                                    className="w-full bg-white/5 border border-white/10 rounded-3xl p-6 text-sm text-white outline-none focus:border-indigo-500/40 h-32 resize-none italic leading-relaxed text-left" 
